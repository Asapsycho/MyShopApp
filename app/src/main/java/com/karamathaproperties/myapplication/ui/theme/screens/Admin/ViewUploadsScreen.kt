package com.karamathaproperties.myapplication.ui.theme.screens.Admin
...
import com.karamathaproperties.myapplication.data.productviewmodel
...
fun ViewUploadsScreen(navController:NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        var emptyUploadListState = remember { mutableListOf<Upload>() }

        var uploads = productRepository.viewUploads(emptyUploadState, emptyUploadListState)
