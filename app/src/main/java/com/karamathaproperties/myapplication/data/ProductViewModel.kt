...
import com.karamathaproperties.myapplication.models.Product
import com.karamathaproperties.myapplication.models.Upload
...
class productviewmodel(var navController: NavHostController, var context: Context) {
    ...
    fun viewProducts(
        ...
        products: SnapshotStateList<com.karamathaproperties.myapplication.ui.theme.screens.product.Product>
    ): SnapshotStateList<com.karamathaproperties.myapplication.ui.theme.screens.product.Product> {
    ...
    fun viewUploads(upload: MutableState<Upload>, uploads: MutableList<Upload>): MutableList<Upload> {
...
private fun <T> SnapshotStateList<T>.add(element: Product) {
